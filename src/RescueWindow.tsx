    ...
    updateRescues(data: any) {
        ...
        if (!!data.included) {
            ...
            for (let newRat of rats) {
                let removeId = this.props.store!.rats.indexOf((r: any) => r.id == newRat.id);
                if (removeId > -1) {
            ...
            for (let removeRat of removeRats) {
                let removeId = this.props.store!.rats.indexOf((r: any) => r.id == removeRat);
                if (removeId > -1) {
        ...
        return (
            <div className="rootElement">
                <div className="mainContainer">
                    ...
                    <div className="gridItem selectedCaseView"><SelectedCaseView/></div>
                    <div className="gridItem assignedCaseView"><AssignedCaseView/></div>
                    <div className="gridItem playerInfoView"><PlayerInfoView/></div>
                    <div className="gridItem filterInfoView"><FilterInfoView/></div>
                </div>
            </div>
        );
    }
