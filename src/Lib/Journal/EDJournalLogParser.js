module.exports = {
  ...
  parseStatusFile(line) {
    ...
    if (!!status) this.localData.Status = status;
  },
  parseLogLine(line) {
    ...
    if (!!logItem) {
      switch (logItem.event) {
        ...
        case "StartJump":
          ...
          this.localData.Player.Pos.Scoopable = ["K", "G", "B", "F", "O", "A", "M"].findIndex(
            item => item === logItem.StarClass
          ) !== -1;
          break;
        case "FSDJump":
          this.localData.Player.Pos = {
        ...
        case "Rank":
          ...
          this.localData.Player.Rank.Federation.Rank =
            logItem.Federation;
        ...
        case "Progress":
          ...
          this.localData.Player.Rank.Explore.Progress =
            logItem.Explore;
          this.localData.Player.Rank.Federation.Progress =
            logItem.Federation;
        ...
        case "Materials":
          ...
          this.localData.CanSynthesizeLifesupport =
            hasIronForSynth && hasNickelForSynth;
